...
<link href="${pageContext.request.contextPath}/bootstrap-3.3.4/css/bootstrap.css" type="text/css"
	rel="stylesheet">
<link href="${pageContext.request.contextPath}/bootstrap-3.3.4/css/bootstrap-theme.css" type="text/css"
	rel="stylesheet">

<script src="${pageContext.request.contextPath}/jquery/jquery-1.11.2.js"></script>
<script src="${pageContext.request.contextPath}/bootstrap-3.3.4/js/bootstrap.js"></script>
